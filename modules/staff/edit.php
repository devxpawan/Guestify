...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (mysqli_query($conn, $query)) {
        ...
        logAudit('UPDATE', 'staff', $id, "Staff member $name updated", $old_staff_data, $new_staff_data);
        ...
        <div class="card-body">
            <form method="POST">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="phone" class="form-control" value="<?= htmlspecialchars($staff['phone']) ?>" maxlength="10" oninput="this.value = this.value.replace(/\D/g, '')" required>
                </div>
                <div class="mb-3">

...
- Multiple pricing models (day, night, short stay)
...
- Categorized transactions (Room Revenue, Utilities, Maintenance, etc.)
- Custom income/expense category management
- Profit/loss summary with monthly breakdown
...
## Room Service
- Room service requests management
- Service request creation for checked-in guests
...
- Top customers and selling products
